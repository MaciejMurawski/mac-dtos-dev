...
output "function_app_url" {
  ...
  value       = { for k, function in azurerm_linux_function_app.function : k => "https://${function.default_hostname}/api/?code=${data.azurerm_function_app_host_keys.fnapphostkey[function.name]}" }
